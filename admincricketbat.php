...
<head>
    ...
    <title>Ballsport - Admin - Cricket Bat</title>
...
if(isset($_POST['submit'])){
    ...
    $sql = "DELETE FROM `admin_bat` WHERE `admin_bat`.`Id` = $id";
                ...
                if($num_rows > 0){
                    ...
                    echo '
                      <tr>
                        ...
                        <td>
                            <form action="admincricketbat.php" method="post">
                        ...
                        <td>
                            <form action="admincu.php" method="post">
                            <input type="hidden" value="'.$id.'" name="id">
