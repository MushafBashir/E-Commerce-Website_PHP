...
<head>
    ...
    <title>Ballsport - Admin - Basketball</title>
...
if(isset($_POST['submit'])){
    ...
    $sql = "DELETE FROM `admin_basketball` WHERE `admin_basketball`.`Id` = $id";
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <table class="table table-sm border">
                    ...
                    <tbody>
              <?php  $sql = "SELECT * from `admin_basketball`";
                $result = mysqli_query($con, $sql);
                ...
                if($num_rows > 0){
                    ...
                    echo '
                      <tr>
                        ...
                        <td>
                            <form action="adminbasketball.php" method="post">
                        ...
                        <td>
                            <form action="adminbu.php" method="post">
                            <input type="hidden" value="'.$id.'" name="id">
