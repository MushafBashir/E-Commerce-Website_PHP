...
<head>
    ...
    <title>Ballsport - Admin - Product Section</title>
...
if(isset($_POST['submit'])){
    ...
    $sql = "DELETE FROM `admin_product` WHERE `admin_product`.`Id` = $id";
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <table class="table table-sm border">
                    ...
                    <tbody>
              <?php  $sql = "SELECT * from `admin_product`";
                $result = mysqli_query($con, $sql);
                ...
                if($num_rows > 0){
                    ...
                    echo '
                      <tr>
                        ...
                        <td>
                            <form action="adminpu.php" method="post">
                            <input type="hidden" value="'.$id.'" name="id">
