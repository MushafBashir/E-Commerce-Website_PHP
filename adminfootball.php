...
<head>
    ...
    <title>Ballsport - Admin - Football</title>
...
if(isset($_POST['submit'])){
    ...
    $sql = "DELETE FROM `admin_football` WHERE `admin_football`.`Id` = $id";
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <table class="table table-sm border">
                    ...
                    <tbody>
              <?php  $sql = "SELECT * from `admin_football`";
                $result = mysqli_query($con, $sql);
                ...
                if($num_rows > 0){
                    ...
                    echo '
                      <tr>
                        ...
                        <td>
                            <form action="adminfootball.php" method="post">
                        ...
                        <td>
                            <form action="adminfu.php" method="post">
                            <input type="hidden" value="'.$id.'" name="id">
