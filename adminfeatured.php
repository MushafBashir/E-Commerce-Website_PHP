...
<head>
    ...
    <title>Ballsport - Admin - Featured Section</title>
...
if(isset($_POST['submit'])){
    ...
    $sql = "DELETE FROM `admin_featured` WHERE `admin_featured`.`Id` = $id";
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <table class="table table-sm border">
                    ...
                    <tbody>
              <?php  $sql = "SELECT * from `admin_featured`";
                $result = mysqli_query($con, $sql);
                ...
                if($num_rows > 0){
                    ...
                    echo '
                      <tr>
                        ...
                        <td>
                            <form action="adminfeatured.php" method="post">
                        ...
                        <td>
                            <form action="adminfeu.php" method="post">
                            <input type="hidden" value="'.$id.'" name="id">
